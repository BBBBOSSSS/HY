...
def main():
    ...
    # 默认按常见训练分辨率 832x480 的 2×；可用 CLI 覆盖
    parser.add_argument("--width", type=int, default=int(os.environ.get("HY2_EXPORT_WIDTH", "1664")))
    parser.add_argument("--height", type=int, default=int(os.environ.get("HY2_EXPORT_HEIGHT", "960")))
    parser.add_argument("--fps", type=int, default=24)
    parser.add_argument("--seconds", type=int, default=20)
    parser.add_argument("--crf", type=int, default=16)
    parser.add_argument("--sh-degree", type=int, default=int(os.environ.get("HY2_SH_DEGREE", "2")))
